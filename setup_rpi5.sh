...
# Raspberry Pi 5 Crowd Counting Setup Script
...
Type=simple
User=pi
WorkingDirectory=/home/pi/RTSAComp
Environment=PATH=/home/pi/RTSAComp/crowd_counter_env/bin
ExecStartPre=/home/pi/RTSAComp/performance_env.sh
ExecStart=/home/pi/RTSAComp/crowd_counter_env/bin/python /home/pi/RTSAComp/rpi_crowd_counter.py
Restart=always
RestartSec=10
...
try:
    ...
    print(f'LWCC import failed: {e}')
    print('You may need to install LWCC manually: pip install lwcc')
"
...
try:
    ...
    if cap.isOpened():
        ...
        print('Camera access failed - check camera connection')
